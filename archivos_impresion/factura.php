...
$hash = $objcon->consulta_arreglo("SELECT * FROM comprobante_hash WHERE pkComprobante = ".$factura['id']);
...
<hr>
<table align="center" border="1" class="productos">
    <tr>
        <th>Cant</th>
        <th>Producto</th>
	<th>Precio Cat</th><!-- prueba-->
        <th></th>
    ...
    if (is_array($productos)):
		...
		<td><?php echo number_format($p['total']/$p['cantidad'], 2, '.', ''); ?></td> <!--prueba-->
                <th width="1%">S/</th>
