...
$obj->consulta_matriz(" SELECT sum(pv.cantidad) as cantidad,sum(pv.total) as totalventa,
FROM producto_venta pv inner join venta v on (v.id=pv.id_venta) where pv.estado_fila=1 AND  v.estado_fila = 1 and fecha_cierre='".$fechahoy."' Group by id_producto");
...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <a href="index.php" class="logo"  style="background: #0F4B81 !important;">
                    ...
                    <span  class="logo-lg"><img src='recursos/img/logo.svg'  height="35px"></span>
                </a>
...
<nav class="navbar navbar-static-top" role="navigation">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Multireportes online
            <small>visita <a ref="http://www.vendeconkatsu.com/" > www.vendeconkatsu.com </a> </small>
          </h1>
          ...
          <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number">Unidades:<?php echo $obj['cantidad'];?><small></small></span>
                  
                  <span class="info-box-number">Total S./: <?php echo $obj['totalventa'];?><small></small></span>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">Servicios Vendidos</span>
                <span class="info-box-number">Cantidad:<?php ?><small></small></span>
                  
                  <span class="info-box-number">Total S./:<small></small></span>
                </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
            </div><!-- /.col -->
