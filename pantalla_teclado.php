                    ...
                    <div class="col-md-4 venta">
                        ...
                        <div class="row cliente-detalle" v-if="showCustomer">
                            <div v-if="showCustomerList" class="col-md-12 animate__animated animate__fadeIn">
                                ...
                                <div class="input-group mb-3">
                                    <input v-model="search_customer" type="text" class="form-control" @click="cutomerFind()" id="" name="" placeholder="Numero de Documento" aria-label="Buscar Cliente" aria-describedby="basic-addon2" id="search_cliente">
                                    <div class="input-group-append">
                                ...
                                <div class="col-md-12" v-if="showAddPerson">
                                    <div class="row animate__animated animate__fadeIn">
                                        ...
                                        <div class="col-md-12 min-top">
                                            <div class="form-group">
                                                <input v-model="nCustomer.document" required type="text" class="form-control size-form-register" placeholder="N° Documento">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input v-model="nCustomer.name" required type="text" class="form-control size-form-register" placeholder="Nombres">
                                            </div>
                                        </div>
                                        <div class="col-md-12 min-top">
                                            <div class="form-group">
                            ...
                            <form @submit.prevent="newCompany">
                                <div class="col-md-12" v-if="showAddCompany">
                                    <div class="row animate__animated animate__fadeIn">
                                        ...
                                        <div class="col-md-12 min-top">
                                            <div class="form-group">
                                                <input required v-model="nCompany.document" type="text" class="form-control size-form-register" placeholder="N° RUC">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
