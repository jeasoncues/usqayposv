...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <!-- Header Navbar -->
        <nav class="navbar navbar-static-top" role="navigation" style="background: #0F4B81 !important">
        ...
        <section class="content row contenedorventa">
                                        ...
                                        <div class="input-group" style="margin-bottom: 10px; width:100%;">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="hidden" class="form-control" placeholder="Escribe para buscar" id="txtbusprodauxcotos">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
            ...
            <div style="height: 300px; overflow-y: scroll;"> 
                ...
                <center>
                    ...
                    <button type="button" class="btn btn-primary btn-lg" style="display:<?php echo $ocultar ?>" id="btnNotaVenta"><b>[F2]</b>Ticket <i class="fa fa-caret-square-o-right" aria-hidden="true" ></i></button>
        ...
        <div class='modal-dialog'>
            <div class='modal-content'>
                ...
                <div class='modal-body'>
                    ...
                    <hr/>
                    <h3 style='display:none'>Orden De Compra / Guia Remitente / Condicion de Pago</h3>
                    
                    <div class="row" id="detallescomprobante" style='display:none'>
                        <div class="col-lg-6 col-xs-6">
    ...
    <script>
        ...
        var longitud_buscar_producto=0
        var longitud_buscar_producto_aux=0
        var opcionbuscarcotos=-1
            ...
            $('#precio_prod').on('change', function(){
                ...
                $.ajax({
                    ...
                    success:function(data) {
                        ...
                        let precio = data.precio_venta / data.cantidad;
        ...
        function busqueda_producto(){
            $("#txtbusprodauxcotos").val($("#txtbusprod").val())
            console.log("busca producto")
            if(offset_producto_bus === -1){
                offset_producto_bus = 0;
            }            
            if(opcionbuscarcotos==1){
                offset_producto_bus=0
                limit_producto_bus=9
            }
            
            console.log("offset_producto_bus:"+offset_producto_bus)
            console.log("limit_producto_bus:"+limit_producto_bus)
            //offset_producto_bus=0
            //limit_producto_bus=9
            let existealgundato=0
            ...
            $.post('ws/taxonomiap.php', {op: 'searchbytax',limit:limit_producto_bus,offset:offset_producto_bus,valor:value}, function(data) {
                if(data !== 0){
                    ...
                    $.notify("No se encuentra Productos o Servicios con la descripcion")
        ...
        function addprod0(idproducto,idtaxonomia,valortaxonomia,idtaxpadre,idtaxabuelo){
            ...
            $.post('ws/producto.php', {op: 'getventa', id: idproducto, id_almacen:id_almacen}, function(data) {
                ...
                if(data !== 0){
                    ...
                    $('#stock_producto').html( parseFloat(data.stock).toFixed(2)+" En stock");
