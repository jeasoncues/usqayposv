...
$almacenes = $objcon->consulta_matriz("Select * from almacen where id = 1 and estado_fila = 1");
...
<div class="wrapper">
                ...
                <div>
                    ...
                    <?php
                        if(isset($_GET['id'])){
                            ...
                            $cliente = !empty($nc['cliente']) ? $nc['cliente'] : '';
            ...
            <div class='modal-content'>
                ...
                <div class='modal-body'>
                    ...
                    <div class="row" id="detallescomprobante">
                        ...
                        <div class="col-lg-4 col-xs-4" style="margin-top: 5px; display: none !important;">
    ...
    <script>
             ...
             $('#precio_prod').on('change', function(){
                ...
                $.ajax({
                    ...
                    success:function(data) {
                        ...
                        let precio = (data.precio_venta / data.cantidad).toFixed(2);
        ...
        function busqueda_producto(){
            ...
            $.post('ws/taxonomiap.php', {op: 'searchbytax',limit:limit_producto_bus,offset:offset_producto_bus,valor:value,id_almacen : $("#almacen_venta").val()}, function(data) {
                if(data !== 0){
                    console.log(data);
                    $('#contenedor_bloques_productos').html('');
                    var ht = '';
