...
$(document).ready(function () {
    ...
    var color=['#E66FF6961','#E661FF69','#E6FF9E61','#E68D87FF','#E6FFD6D4'];
   ...
   $('#tblKardex').DataTable({
    ...
    var chartData = {
			labels:['Nota de Venta','Boleta','Factura','Nota de Debito','Nota de Credito'],
			datasets:[{
				label:['Nota de Venta','Boleta','Factura','Nota de Debito','Nota de Credito'],
...
function pantalla_notas(id_venta,nota){
    //location.href ="pantalla_credito_debito.php?id="+id_venta+"&&nota="+nota;
    location.href ="nota_credito_debito.php?id="+id_venta+"&&nota="+nota;
